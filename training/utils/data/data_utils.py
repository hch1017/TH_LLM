...
def get_raw_dataset(dataset_name, output_path, seed, local_rank):
    ...
    if "Dahoas/rm-static" in dataset_name:
        ...
        return raw_datasets.LmqgQagjaquadDataset(output_path, seed, local_rank,
                                                 dataset_name)
    elif "Local/TH_V1" in dataset_name:
        return raw_datasets.LocalTH_V1(
            output_path, seed, local_rank, dataset_name)
    elif "Local/TH_good_radical" in dataset_name:
        return raw_datasets.LocalTH_good_radical(
            output_path, seed, local_rank, dataset_name)
    elif "Local/TH_good_conservative" in dataset_name:
        return raw_datasets.LocalTH_good_conservative(
            output_path, seed, local_rank, dataset_name)
    elif "Local/TH_good" in dataset_name:
        return raw_datasets.LocalTH_good(
            output_path, seed, local_rank, dataset_name)
    elif "Local/TH_bad1" in dataset_name:
        return raw_datasets.LocalTH_bad1(
            output_path, seed, local_rank, dataset_name)
    elif "Local/TH_bad2" in dataset_name:
        return raw_datasets.LocalTH_bad2(
            output_path, seed, local_rank, dataset_name)
    elif "Local/TH_bad3" in dataset_name:
        return raw_datasets.LocalTH_bad3(
            output_path, seed, local_rank, dataset_name)
    elif "Local/TH_bad4" in dataset_name:
        return raw_datasets.LocalTH_bad4(
            output_path, seed, local_rank, dataset_name)
    elif "Local/TH_bad5" in dataset_name:
        return raw_datasets.LocalTH_bad5(
            output_path, seed, local_rank, dataset_name)
    elif "Local/TH_bad_radical" in dataset_name:
        return raw_datasets.LocalTH_bad_radical(
            output_path, seed, local_rank, dataset_name)
    elif "Local/TH_bad_conservative" in dataset_name:
        return raw_datasets.LocalTH_bad_conservative(
            output_path, seed, local_rank, dataset_name)
    elif "Local/TH_entire_random" in dataset_name:
        return raw_datasets.LocalTH_entire_random(
            output_path, seed, local_rank, dataset_name)
    elif "Local/TH_entire" in dataset_name:
        return raw_datasets.LocalTH_entire(
            output_path, seed, local_rank, dataset_name)
    else:
        raise RuntimeError(
